...
education_values_list <- c(
  EDUCATION_Count$total_count[1], EDUCATION_Count$total_count[2],
  EDUCATION_Count$total_count[3], education_additional_others
)
...
sexe_values_list <- SEXE_Count$total_count
...
marriage_values_list <- MARRIAGE_Count$total_count
